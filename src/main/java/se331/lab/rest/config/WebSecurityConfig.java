...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.GET,"/patients/doctor").permitAll()
                .antMatchers(HttpMethod.GET,"/patients/{id}").permitAll()
                .antMatchers(HttpMethod.POST,"/patients/patients/vaccine/{id}").permitAll()
                .antMatchers(HttpMethod.POST,"/signup").permitAll()
                .antMatchers(HttpMethod.PUT,"/user/{id}").permitAll()
                .antMatchers(HttpMethod.GET,"/doctors/").permitAll()
                .antMatchers(HttpMethod.GET,"/doctors/profile/{username}").permitAll()
                .antMatchers(HttpMethod.GET,"/doctors/{username}").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/patients/vaccines/{id}").permitAll()
